...
contract StarNotary is ERC721 { 
    ...
    */
    function createStar(string name, string story,  string ra, string dec, string mag) public {
        ...
        Star memory newStar = Star(name, story, Coordinates(ra, dec, mag));
    ...
    function getInfoFor(uint256 tokenId) public view returns(string, string, string, string, string) {
